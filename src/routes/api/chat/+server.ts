...
export const POST = async ({ request }) => {
    ...
    if (reqData.conversationHistory.length === 0) {
        ...
        End Conversation: If the user persists, close the conversation politely. Offer a friendly farewell and inform them that the session is ending to maintain a respectful experience.        Here is the scenario/scene: ${reqData.scenario}
